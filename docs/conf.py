...
github_project_url = "https://github.com/jquast/telnetlib"
...
release = "2.0.4"  # keep in sync with setup.py and telnetlib/accessories.py !!
...
htmlhelp_basename = "telnetlib_doc"
...
# [howto/manual]).
latex_documents = [
    ("index", "telnetlib.tex", "Telnetlib3 Documentation", "Jeff Quast", "manual"),
]
...
man_pages = [("index", "telnetlib", "Telnetlib3 Documentation", ["Jeff Quast"], 1)]
